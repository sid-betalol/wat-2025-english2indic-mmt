...
# Training 1: LoRA Multi-GPU
echo "================================================================="
echo "TRAINING 1/2: LoRA Multi-GPU"
echo "================================================================="
run_training "lora" "true" "32" "models/indictrans2-lora-2gpu-$TIMESTAMP" "3"
...
# Training 2: Full Multi-GPU
echo ""
echo "================================================================="
echo "TRAINING 2/2: Full Multi-GPU"
echo "================================================================="
run_training "full" "true" "24" "models/indictrans2-full-2gpu-$TIMESTAMP" "3"
